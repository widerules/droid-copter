...
void IsAlive(byte flag, byte numOfValues);
int count = 0;
...
void setup() {
  Serial.begin(BAUD);
  Serial1.begin(57600);    // bluetooth module;
  ...
  digitalWrite(LEDPIN, LOW);
    ...
    pinMode(34, INPUT);
    pinMode(35, INPUT);
    meetAndroid.registerFunction(receiveRoll, 'R'); 
    meetAndroid.registerFunction(receivePitch, 'P'); 
    meetAndroid.registerFunction(receiveYaw, 'Y');  
    meetAndroid.registerFunction(receiveThrottle, 'T');
    meetAndroid.registerFunction(receiveMode, 'M');
    meetAndroid.registerFunction(receiveArm, 'A');
    meetAndroid.registerFunction(receiveDisarm, 'D');
    meetAndroid.registerFunction(receiveCalibrate, 'C');
    meetAndroid.registerFunction(IsAlive, 'I');
